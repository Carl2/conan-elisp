...
#+begin_src example
#+HEADER: :main no
#+HEADER: :flags (col/conan-elisp-install "fmt/10.1.1 sml/1.1.9" 'all "-std=c++20 -Wall -Wextra" "-lto")
...
#+HEADER: :main no
#+HEADER: :flags (col/conan-elisp-install "fmt/10.1.1 sml/1.1.9" 'all "-std=c++20 -Wall -Wextra" "-O3")
